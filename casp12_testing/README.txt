...
predictions_data and rankings_data are directories containing necessary input files for the execution of main_casp12.py . To create these directories the scripts download_predictions_data.py and download_rankings_data.py were used.
